...
Namespace UserTableTableAdapters
    ...
    Partial Public Class USER_ACCTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [USER_ACC] WHERE (([USERNAME] = @Original_USERNAME) AND ([NAME] = @Or"& _ 
                "iginal_NAME) AND ([ADDRESS] = @Original_ADDRESS) AND ([JOB] = @Original_JOB) AND"& _ 
                " ([PIN] = @Original_PIN) AND ([BALANCE] = @Original_BALANCE))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [USER_ACC] ([USERNAME], [NAME], [ADDRESS], [JOB], [PIN], [BALANCE]) V"& _ 
                "ALUES (@USERNAME, @NAME, @ADDRESS, @JOB, @PIN, @BALANCE);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT USERNAME, NAME"& _ 
                ", ADDRESS, JOB, PIN, BALANCE FROM USER_ACC WHERE (USERNAME = @USERNAME)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [USER_ACC] SET [USERNAME] = @USERNAME, [NAME] = @NAME, [ADDRESS] = @ADDRES"& _ 
                "S, [JOB] = @JOB, [PIN] = @PIN, [BALANCE] = @BALANCE WHERE (([USERNAME] = @Origin"& _ 
                "al_USERNAME) AND ([NAME] = @Original_NAME) AND ([ADDRESS] = @Original_ADDRESS) A"& _ 
                "ND ([JOB] = @Original_JOB) AND ([PIN] = @Original_PIN) AND ([BALANCE] = @Origina"& _ 
                "l_BALANCE));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT USERNAME, NAME, ADDRESS, JOB, PIN, BALANCE FROM USER_ACC WH"& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT USERNAME, NAME, ADDRESS, JOB, PIN, BALANCE FROM USER_ACC"
            ...
            Me._commandCollection(2).CommandText = "SELECT ADDRESS, BALANCE, JOB, NAME, PIN, USERNAME FROM USER_ACC WHERE (USERNAME ="& _ 
                " @username)"
            ...
            Me._commandCollection(4).CommandText = "INSERT INTO [dbo].[USER_ACC] ([USERNAME], [NAME], [ADDRESS], [JOB], [PIN], [BALAN"& _ 
                "CE]) VALUES (@USERNAME, @NAME, @ADDRESS, @JOB, @PIN, @BALANCE);"
    ...
    Partial Public Class TRANSACTION_HISTTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "select * from TRANSACTION_HIST where id= @ID"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "select * from TRANSACTION_HIST where username = @username and date >= DATEADD(Mon"& _ 
                "th, -1, getdate())"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@username", Global.System.Data.SqlDbType.VarChar, 20, Global.System.Data.ParameterDirection.Input, 0, 0, "USERNAME", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(3) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(3).Connection = Me.Connection
            Me._commandCollection(3).CommandText = "INSERT INTO TRANSACTION_HIST(USERNAME,AMOUNT,DATE,IS_TAKING)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"VALUES (@username,@"& _ 
            ...
            Me._commandCollection(3).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@is_taking", Global.System.Data.SqlDbType.Bit, 1, Global.System.Data.ParameterDirection.Input, 0, 0, "IS_TAKING", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataByID(ByVal ID As Integer) As UserTable.TRANSACTION_HISTDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataByUsername(ByVal username As String) As UserTable.TRANSACTION_HISTDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            If (username Is Nothing) Then
                Throw New Global.System.ArgumentNullException("username")
            Else
